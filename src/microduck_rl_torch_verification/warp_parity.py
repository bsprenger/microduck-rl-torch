"""Compare a Torch rollout with the reference MuJoCo-Warp task."""
...
def format_parity_table(
    ...
    *,
    ...
    label: str = "Torch vs MuJoCo-Warp reference",
) -> str:
...
def write_parity_report(
    ...
    *,
    ...
    lines = [
        ...
        "reference `mjlab` MuJoCo-Warp task. Each row is cumulative through the "
