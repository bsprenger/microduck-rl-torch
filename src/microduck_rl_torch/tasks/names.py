"""Microduck task identifiers, without a registration mechanism."""
...
MJLAB_VELOCITY_FLAT_MICRODUCK = BASE_TASK_NAMES[0]
MJLAB_VELOCITY_ROUGH_MICRODUCK = BASE_TASK_NAMES[1]
