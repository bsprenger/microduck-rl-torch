"""Backlash task overlay and model-variant configuration."""
...
def make_backlash_variant(cfg: TaskEnvCfg, robot_cfg: EntityCfg) -> TaskEnvCfg:
    ...
    The base task's manager graph is preserved while the robot entity and
    actuator/encoder behavior are swapped. All term collections are copied;
    the model variant and task name are the only required changes.
    """
