...
def _probe_video_duration(video: Path) -> float | None:
    ...
    ffmpeg is still the only hard requirement for conversion. The duration probe
    preserves ordinary video lengths while retaining the one-frame padding
    safeguard below; without ffprobe, conversion uses ffmpeg alone.
    """
